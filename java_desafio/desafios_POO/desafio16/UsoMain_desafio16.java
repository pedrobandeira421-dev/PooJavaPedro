...
// DESAFIO 16 — Sistema escolar completo (Uso)
...
public class UsoMain_desafio16 {
    public static void main(String[] args) {
        ...
        escola.cadastrarCurso("Informática", 1200);
        escola.cadastrarProfessor("Prof. Marcos", "Banco de Dados e Java");
        escola.cadastrarDisciplina("POO em Java", 80);
        escola.cadastrarAluno("Pedro Silva", 1001, escola.buscarCurso("Informática"));
